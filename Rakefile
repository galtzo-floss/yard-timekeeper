...
# yard-timekeeper Rakefile v1.0.0 - 2026-04-11
...
# rake install                                # Build and install yard-timekeeper-1.0.0.gem in...
# rake install:local                          # Build and install yard-timekeeper-1.0.0.gem in...
# rake kettle:jem:install                     # Install yard-timekeeper GitHub automation and ...
# rake kettle:jem:selftest                    # Self-test: template yard-timekeeper against itse...
# rake kettle:jem:template                    # Template yard-timekeeper files into the curren...
