...
Gem::Specification.new do |spec|
  ...
  spec.version = Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/yard/timekeeper/version.rb", mod) }::Yard::Timekeeper::Version::VERSION
  ...
  spec.homepage = "https://github.com/galtzo-floss/yard-timekeeper"
  spec.licenses = ["MIT"]
  ...
  spec.metadata["homepage_uri"] = "https://yard-timekeeper.galtzo.com"
  ...
  # The 'git' gem is optional; yard-timekeeper falls back to shelling out to `git` if it is not present.
